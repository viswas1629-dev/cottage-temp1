          ...
          >
            ...
            <div className="flex flex-col min-w-0 justify-center">
              ...
              <div className="flex sm:hidden items-start gap-2 leading-none">
                ...
                <div
                  className={`font-serif italic text-[24px] lg:text-[16px] font-bold flex-shrink-0 mt-8.5 -translate-x-3 ${
                    isDarkStyle
                      ? 'text-[#6caca0]'
                ...
                <div
                  className={`font-serif italic text-[24px] lg:text-[16px] font-bold flex-shrink-0 mt-8.5 -translate-x-3.5 ${
                    isDarkStyle
                      ? 'text-[#c075b7]'
